...
3. Replace `{version}` with [the latest version](https://github.com/bbook/0x-mesh/releases) of Mesh.
...
are detailed in the [Config](https://godoc.org/github.com/bbook/0x-mesh/core#Config)
