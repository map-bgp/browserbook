...
func getDocsCommitHash(docsPath string) (string, error) {
	...
	regex := "https://github.com/bbook/0x-mesh/blob/([a-f0-9]+)/"
	var re = regexp.MustCompile(regex)
