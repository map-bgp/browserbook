...
import (
	...
	"github.com/bbook/0x-mesh/common/types"
	"github.com/bbook/0x-mesh/constants"
	"github.com/bbook/0x-mesh/core/ordersync"
	"github.com/bbook/0x-mesh/db"
	"github.com/bbook/0x-mesh/encoding"
	"github.com/bbook/0x-mesh/ethereum"
	"github.com/bbook/0x-mesh/ethereum/blockwatch"
	"github.com/bbook/0x-mesh/ethereum/ethrpcclient"
	"github.com/bbook/0x-mesh/ethereum/ratelimit"
	"github.com/bbook/0x-mesh/keys"
	"github.com/bbook/0x-mesh/loghooks"
	"github.com/bbook/0x-mesh/orderfilter"
	"github.com/bbook/0x-mesh/p2p"
	"github.com/bbook/0x-mesh/zeroex"
	"github.com/bbook/0x-mesh/zeroex/ordervalidator"
	"github.com/bbook/0x-mesh/zeroex/orderwatch"
...
func getPublishTopics(chainID int, contractAddresses ethereum.ContractAddresses, customFilter *orderfilter.Filter) ([]string, error) {
	...
	if defaultTopic == customTopic {
		...
		// See https://github.com/bbook/0x-mesh/pull/563
		return []string{defaultTopic, customTopic}, nil
	}
}

func (app *App) getRendezvousPoints() ([]string, error) {
	defaultRendezvousPoint := "/0x-mesh/network/2/version/2"
