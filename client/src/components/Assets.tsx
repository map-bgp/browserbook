...
for (let i = 0; i < numTiles; i++) {
  tiles.push(
    <div key={i}
         className="w-2/3 sm:w-full max-w-sm bg-white shadow-md rounded-md cursor-pointer focus:outline-none focus:ring-4 focus:ring-blue-400 focus:ring-opacity-50">
