...
import { useAppDispatch, useAppSelector, useContract, useEthers } from "../store/Hooks";
...
import { selectEthersAddress, selectEthersConnected } from "../store/slices/EthersSlice";
